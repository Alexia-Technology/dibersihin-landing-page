<template>
  <div class="header-container">
    <header
      class="the-header"
      :class="{ 'the-header--hidden': !showNavbar }"
      id="nav"
    >
      ...
      <div class="logo ">
        <nuxt-link to="/"
          ><img
            class="is-vertical-center"
            src="dibersihin-logo.svg"
            alt="Digawean Logo"
          />
        </nuxt-link>
      </div>
      ...
      <div class="navigation-items">
        <ul class="nav-list">
          ...
          <li class="nav-item p-b-4">
            <nuxt-link class="nuxt-link-active" to="tutorial">
              Tutorial  
            </nuxt-link>
          </li>
          <li class="nav-item p-b-4">
            <nuxt-link class="nuxt-link-active" to="FAQ">
              FAQ
            </nuxt-link>
          </li>
           <li class="nav-item p-b-4 ">
